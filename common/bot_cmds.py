...
private = [
    ...
    BotCommand(command="enter_city", description="Enter your city"),
    ...
    BotCommand(command="cancel", description="Cancel actions"),
    BotCommand(command="go_back", description="Go back to previous step")
]
